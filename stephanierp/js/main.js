...
window.initService = (service) => {
  $("#service-icon").css("background-image", "url(" + service.icon + ")");
  $("#service-title").html(service.title);
  $("#service-title-2").html(service.title2);
  $("#service-name").html(service.name);
  $("#service-page-title").html(service.name);
  $("#service-installs").html(service.installs);
  ...
  service.images.forEach((image, i) => {
    ...
    $("#service-images-indicator").append(
